  ...
  <section class="content">
    ...
    <div class="col-md-12 col-xs-12">
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <?php
          //echo strtotime('2021-07-05');
        ?>

        <?php if(in_array('createOrder', $user_permission)): ?>
          <a href="<?php echo base_url('records/create') ?>" class="btn btn-primary">Add Record</a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Records</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('records/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'records/fetchrecordsData/'+selected_date,
    'order': [],
    responsive: true,
  ...
  $('#daily_date').on( 'change', function () {
    ...
    manageTable = $('#manageTable').DataTable({
      'ajax': base_url + 'records/fetchrecordsData/'+data,
