    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('records/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                    ...
                    <?php if(isset($order_data['order_item'])): ?>
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       <tr id="row_<?php echo $x; ?>">
                          <td><?php echo $val['name']." ". $val['variation_name'];?></td>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'records/printDiv/'.$order_data['order']['o_id'] ?>" class="btn btn-default" >Print</a>
                <button type="submit" class="btn btn-primary">Save Changes</button>
                <a href="<?php echo base_url('records/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  function printOrder(id)
  {
    if(id) {
      ...
      $.ajax({
        url: base_url + 'records/printDiv/' + id,
        type: 'post',
  ...
  $(document).ready(function() {
    ...
    $("#managerecordsNav").addClass('active');
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      $.ajax({
          url: base_url + '/records/getTableProductRow/',
          type: 'post',
          dataType: 'json',
          success:function(response) {
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $.ajax({
        url: base_url + 'records/getProductValueById',
        type: 'post',
